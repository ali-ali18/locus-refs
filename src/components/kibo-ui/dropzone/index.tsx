...
export const DropzoneContent = ({
  ...
  return (
    <div className={cn("flex flex-col items-center justify-center", className)}>
      <div className="flex size-8 items-center justify-center rounded-xl bg-primary text-muted-foreground">
        <UploadIcon size={16} />
      </div>
      ...
      <p className="w-full text-wrap text-muted-foreground text-xs">
        Arraste e solte ou clique para fazer o upload de uma imagem, arquivos de
        até 5 MB são suportados.
      </p>
    </div>
  );
};
  ...
  return (
    <div className={cn("flex flex-col items-center justify-center", className)}>
      ...
      <p className="my-2 w-full truncate text-wrap font-medium text-sm">
        Fazer upload de {maxFiles === 1 ? "um arquivo" : "arquivos"}
      </p>
